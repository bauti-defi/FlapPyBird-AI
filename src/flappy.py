...
from .ai.genetic_algorithm import GeneticAlgorithm, BIRD_NUMBER
    ...
    async def agent_play(self):
        ...
        while True:
            for bird in self.population:
                ...
                for pipe_upper, pipe_lower in zip(self.pipes.upper, self.pipes.lower):
                    if bird.crossed(pipe_upper) and bird.crossed(pipe_lower):
                        bird.add_score()
                        self.score.add()
